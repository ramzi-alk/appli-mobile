...
<div class="titre">
<h2>Êtes-vous sûrs de vouloir supprimer la vente ? </h2>
</div>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . "/include/btn.html"; ?>
        ...
        if(isset($_GET['id']) == TRUE && $_GET['id'] > 0 ){
            ...
            if(isset($_POST['envoyer']) == true){
                ...
                try{
                    ...
                    $req = $bdd->prepare("delete from ventes where id = :par_id");
                    ...
                    die("Err BDdelete : erreur lors de la suppression dans sup_ventes.php<br>Message d'erreur :" . $e->getMessage()); 
                }
    ...
    ?>
        <form action="sup_ventes.php?id=<?php echo $id;?>" method="POST">
