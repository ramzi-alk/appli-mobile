...
<?php include $_SERVER['DOCUMENT_ROOT'] . "/include/btn.html"; ?>
        ...
        if(isset($_GET['id']) == TRUE && $_GET['id'] > 0 ){
            ...
            if(isset($_POST['envoyer']) == true){
                ...
                try{
                    ...
                    $req = $bdd->prepare("delete from accessoires where id = :par_id");
                    ...
                    if ($req->rowCount() > 0) {
                        ...
                        $msg = "<p style='color: green;'>L'accessoires a bien été supprimé</p>";
    ...
    ?>
        <form action="sup_accessoires.php?id=<?php echo $id;?>" method="POST">
