...
<section class="content">
    ...
    <?php if(isset($_GET['id'] )== true && $_GET['id'] > 0 && isset($_GET['idVit']) == true && $_GET['idVit'] > 0){
        ...
        try{
            ...
            $lesEnregs = $bdd->query("select id_modele as 'idMod', id_ecran as 'id_vit', nombreStock as 'nbStock' from modele_ecran where id_modele = $id and id_ecran = $idVit");
        ...
        if ($lesEnregs->rowCount() == 0) {
         ...
         if(isset($_POST['envoyer']) == true){
            ...
            try{
                ...
                $req = $bdd->prepare("update modele_ecran set nombreStock = :par_nbStock where id_modele = :par_id and id_ecran = :par_idVit  ");
